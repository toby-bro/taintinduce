...
class TestJNRegisters:
    ...
    def test_r1_properties(self) -> None:
    ...
    def test_r2_properties(self) -> None:
...
class TestJNInstructionEncoding:
    ...
    def test_decode_add_r1_r2(self) -> None:
    ...
    def test_decode_add_r1_imm(self) -> None:
    ...
    def test_hex_string_decode(self) -> None:
        """Test decoding from hex string."""
        instr = decode_hex_string('1A')
        assert instr.opcode == JNOpcode.ADD_R1_IMM
        assert instr.immediate == 0xA

    def test_encode_instruction_helper(self) -> None:
    ...
    def test_all_opcodes_encode_decode(self) -> None:
...
class TestJNInstructionExecution:
    ...
    def test_add_r1_r2_no_overflow(self) -> None:
    ...
    def test_add_r1_r2_with_overflow(self) -> None:
...
class TestJNInstructionMnemonics:
    ...
    def test_add_r1_r2_mnemonic(self) -> None:
        """Test ADD R1, R2 mnemonic."""
        instr = JNInstruction(JNOpcode.ADD_R1_R2)
        assert instr.mnemonic == 'ADD R1, R2'

    def test_add_r1_imm_mnemonic(self) -> None:
        """Test ADD R1, imm4 mnemonic."""
        instr = JNInstruction(JNOpcode.ADD_R1_IMM, 0xA)
        assert instr.mnemonic == 'ADD R1, 0xA'

    def test_xor_r1_imm_mnemonic(self) -> None:
...
class TestJNDecodingRegressionPrevention:
    ...
    def test_single_char_6_decodes_to_xor_r1_r2_not_xor_imm(self) -> None:
    ...
    def test_single_char_4_decodes_to_and_r1_r2(self) -> None:
    ...
    def test_two_char_immediate_7a(self) -> None:
    ...
    def test_command_line_usage_6_is_single_nibble(self) -> None:
    ...
    def test_roundtrip_encoding_decoding(self) -> None:
    ...
    def test_decode_handles_various_formats(self) -> None:
    ...
    def test_immediate_instructions_still_work(self) -> None:
